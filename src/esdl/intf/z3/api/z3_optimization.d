...
*/
extern(C) Z3_optimize Z3_mk_optimize (Z3_context c);
...
*/
extern(C) void Z3_optimize_inc_ref (Z3_context c, Z3_optimize d);
...
*/
extern(C) void Z3_optimize_dec_ref (Z3_context c, Z3_optimize d);
...
*/
extern(C) void Z3_optimize_assert (Z3_context c, Z3_optimize o, Z3_ast a);
...
*/
extern(C) void Z3_optimize_assert_and_track (Z3_context c, Z3_optimize o, Z3_ast a, Z3_ast t);
...
*/
extern(C) uint Z3_optimize_assert_soft (Z3_context c, Z3_optimize o, Z3_ast a, Z3_string weight, Z3_symbol id);
...
*/
extern(C) uint Z3_optimize_maximize (Z3_context c, Z3_optimize o, Z3_ast t);
...
*/
extern(C) uint Z3_optimize_minimize (Z3_context c, Z3_optimize o, Z3_ast t);
...
*/
extern(C) void Z3_optimize_push (Z3_context c, Z3_optimize d);
...
*/
extern(C) void Z3_optimize_pop (Z3_context c, Z3_optimize d);
...
*/
extern(C) Z3_lbool Z3_optimize_check (Z3_context c, Z3_optimize o, uint num_assumptions, const(Z3_ast)* assumptions);
...
*/
extern(C) Z3_string Z3_optimize_get_reason_unknown (Z3_context c, Z3_optimize d);
...
*/
extern(C) Z3_model Z3_optimize_get_model (Z3_context c, Z3_optimize o);
 ...
 */
extern(C) Z3_ast_vector Z3_optimize_get_unsat_core (Z3_context c, Z3_optimize o);
...
*/
extern(C) void Z3_optimize_set_params (Z3_context c, Z3_optimize o, Z3_params p);
...
*/
extern(C) Z3_param_descrs Z3_optimize_get_param_descrs (Z3_context c, Z3_optimize o);
...
*/
extern(C) Z3_ast Z3_optimize_get_lower (Z3_context c, Z3_optimize o, uint idx);
...
*/
extern(C) Z3_ast Z3_optimize_get_upper (Z3_context c, Z3_optimize o, uint idx);
...
*/
extern(C) Z3_ast_vector Z3_optimize_get_lower_as_vector (Z3_context c, Z3_optimize o, uint idx);
...
*/
extern(C) Z3_ast_vector Z3_optimize_get_upper_as_vector (Z3_context c, Z3_optimize o, uint idx);
...
*/
extern(C) Z3_string Z3_optimize_to_string (Z3_context c, Z3_optimize o);
...
*/
extern(C) void Z3_optimize_from_string (Z3_context c, Z3_optimize o, Z3_string s);
...
*/
extern(C) void Z3_optimize_from_file (Z3_context c, Z3_optimize o, Z3_string s);
...
*/
extern(C) Z3_string Z3_optimize_get_help (Z3_context c, Z3_optimize t);
...
*/
extern(C) Z3_stats Z3_optimize_get_statistics (Z3_context c, Z3_optimize d);
...
*/
extern(C) Z3_ast_vector Z3_optimize_get_assertions (Z3_context c, Z3_optimize o);
...
*/
extern(C) Z3_ast_vector Z3_optimize_get_objectives (Z3_context c, Z3_optimize o);
