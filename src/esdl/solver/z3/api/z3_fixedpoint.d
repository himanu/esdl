...
*/
extern(C) Z3_fixedpoint Z3_mk_fixedpoint (Z3_context c);
...
*/
extern(C) void Z3_fixedpoint_inc_ref (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) void Z3_fixedpoint_dec_ref (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) void Z3_fixedpoint_add_rule (Z3_context c, Z3_fixedpoint d, Z3_ast rule, Z3_symbol name);
...
*/
extern(C) void Z3_fixedpoint_add_fact (
    Z3_context c,
    Z3_fixedpoint d,
    Z3_func_decl r,
    uint num_args,
...
*/
extern(C) void Z3_fixedpoint_assert (Z3_context c, Z3_fixedpoint d, Z3_ast axiom);
...
*/
extern(C) Z3_lbool Z3_fixedpoint_query (Z3_context c, Z3_fixedpoint d, Z3_ast query);
...
*/
extern(C) Z3_lbool Z3_fixedpoint_query_relations (
    Z3_context c,
    Z3_fixedpoint d,
    uint num_relations,
...
*/
extern(C) Z3_ast Z3_fixedpoint_get_answer (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) Z3_string Z3_fixedpoint_get_reason_unknown (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) void Z3_fixedpoint_update_rule (Z3_context c, Z3_fixedpoint d, Z3_ast a, Z3_symbol name);
...
*/
extern(C) uint Z3_fixedpoint_get_num_levels (Z3_context c, Z3_fixedpoint d, Z3_func_decl pred);
 ...
 */
extern(C) Z3_ast Z3_fixedpoint_get_cover_delta (Z3_context c, Z3_fixedpoint d, int level, Z3_func_decl pred);
...
*/
extern(C) void Z3_fixedpoint_add_cover (Z3_context c, Z3_fixedpoint d, int level, Z3_func_decl pred, Z3_ast property);
...
*/
extern(C) Z3_stats Z3_fixedpoint_get_statistics (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) void Z3_fixedpoint_register_relation (Z3_context c, Z3_fixedpoint d, Z3_func_decl f);
...
*/
extern(C) void Z3_fixedpoint_set_predicate_representation (
    Z3_context c,
    Z3_fixedpoint d,
    Z3_func_decl f,
    uint num_relations,
 ...
 */
extern(C) Z3_ast_vector Z3_fixedpoint_get_rules (Z3_context c, Z3_fixedpoint f);
 ...
 */
extern(C) Z3_ast_vector Z3_fixedpoint_get_assertions (Z3_context c, Z3_fixedpoint f);
...
*/
extern(C) void Z3_fixedpoint_set_params (Z3_context c, Z3_fixedpoint f, Z3_params p);
...
*/
extern(C) Z3_string Z3_fixedpoint_get_help (Z3_context c, Z3_fixedpoint f);
...
*/
extern(C) Z3_param_descrs Z3_fixedpoint_get_param_descrs (Z3_context c, Z3_fixedpoint f);
...
*/
extern(C) Z3_string Z3_fixedpoint_to_string (
    Z3_context c,
    Z3_fixedpoint f,
    uint num_queries,
    Z3_ast* queries);
...
*/
extern(C) Z3_ast_vector Z3_fixedpoint_from_string (
    Z3_context c,
    Z3_fixedpoint f,
    Z3_string s);
...
*/
extern(C) Z3_ast_vector Z3_fixedpoint_from_file (
    Z3_context c,
    Z3_fixedpoint f,
    Z3_string s);
...
extern(C) void Z3_fixedpoint_init (Z3_context c, Z3_fixedpoint d, void* state);
...
*/
extern(C) void Z3_fixedpoint_set_reduce_assign_callback (
    Z3_context c,
    Z3_fixedpoint d,
    void function () cb);

/** \brief Register a callback for building terms based on the relational operators. */
extern(C) void Z3_fixedpoint_set_reduce_app_callback (
    Z3_context c,
    Z3_fixedpoint d,
    void function () cb);

alias Z3_fixedpoint_new_lemma_eh = void function (void* state, Z3_ast lemma, uint level);
alias Z3_fixedpoint_predecessor_eh = void function (void* state);
alias Z3_fixedpoint_unfold_eh = void function (void* state);

/** \brief set export callback for lemmas */
extern(C) void Z3_fixedpoint_add_callback (
    Z3_context ctx,
    Z3_fixedpoint f,
    void* state,
...
extern(C) void Z3_fixedpoint_add_constraint (Z3_context c, Z3_fixedpoint d, Z3_ast e, uint lvl);
