module esdl.solver.z3.api.z3_spacer;
...
*/
extern(C) Z3_lbool Z3_fixedpoint_query_from_lvl (Z3_context c, Z3_fixedpoint d, Z3_ast query, uint lvl);
...
*/
extern(C) Z3_ast Z3_fixedpoint_get_ground_sat_answer (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) Z3_ast_vector Z3_fixedpoint_get_rules_along_trace (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) Z3_symbol Z3_fixedpoint_get_rule_names_along_trace (Z3_context c, Z3_fixedpoint d);
...
*/
extern(C) void Z3_fixedpoint_add_invariant (Z3_context c, Z3_fixedpoint d, Z3_func_decl pred, Z3_ast property);
 ...
 */
extern(C) Z3_ast Z3_fixedpoint_get_reachable (Z3_context c, Z3_fixedpoint d, Z3_func_decl pred);
...
*/
extern(C) Z3_ast Z3_qe_model_project (
    Z3_context c,
    Z3_model m,
    uint num_bounds,
    const(Z3_app)* bound,
...
*/
extern(C) Z3_ast Z3_qe_model_project_skolem (
    Z3_context c,
    Z3_model m,
    uint num_bounds,
    const(Z3_app)* bound,
...
*/
extern(C) Z3_ast Z3_model_extrapolate (Z3_context c, Z3_model m, Z3_ast fml);
...
*/
extern(C) Z3_ast Z3_qe_lite (Z3_context c, Z3_ast_vector vars, Z3_ast body_);
