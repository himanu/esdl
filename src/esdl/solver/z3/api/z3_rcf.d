module esdl.solver.z3.api.z3_rcf;
...
*/
extern(C) void Z3_rcf_del (Z3_context c, Z3_rcf_num a);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mk_rational (Z3_context c, Z3_string val);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mk_small_int (Z3_context c, int val);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mk_pi (Z3_context c);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mk_e (Z3_context c);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mk_infinitesimal (Z3_context c);
...
*/
extern(C) uint Z3_rcf_mk_roots (Z3_context c, uint n, const(Z3_rcf_num)* a, Z3_rcf_num* roots);
...
*/
extern(C) Z3_rcf_num Z3_rcf_add (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) Z3_rcf_num Z3_rcf_sub (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) Z3_rcf_num Z3_rcf_mul (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) Z3_rcf_num Z3_rcf_div (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) Z3_rcf_num Z3_rcf_neg (Z3_context c, Z3_rcf_num a);
...
*/
extern(C) Z3_rcf_num Z3_rcf_inv (Z3_context c, Z3_rcf_num a);
...
*/
extern(C) Z3_rcf_num Z3_rcf_power (Z3_context c, Z3_rcf_num a, uint k);
...
*/
extern(C) bool Z3_rcf_lt (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) bool Z3_rcf_gt (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) bool Z3_rcf_le (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) bool Z3_rcf_ge (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) bool Z3_rcf_eq (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) bool Z3_rcf_neq (Z3_context c, Z3_rcf_num a, Z3_rcf_num b);
...
*/
extern(C) Z3_string Z3_rcf_num_to_string (Z3_context c, Z3_rcf_num a, bool compact, bool html);
...
*/
extern(C) Z3_string Z3_rcf_num_to_decimal_string (Z3_context c, Z3_rcf_num a, uint prec);
...
*/
extern(C) void Z3_rcf_get_numerator_denominator (Z3_context c, Z3_rcf_num a, Z3_rcf_num* n, Z3_rcf_num* d);
