module esdl.solver.z3.api.z3_api;
...
enum string Z3NotLoadedError = "Please make sure that Z3 library is linked in";
...
*/
extern(C) void Z3_global_param_set (Z3_string param_id, Z3_string param_value);
...
*/
extern(C) void Z3_global_param_reset_all ();
...
*/
extern(C) Z3_bool Z3_global_param_get (Z3_string param_id, Z3_string_ptr param_value);
...
*/
extern(C) Z3_config Z3_mk_config ();
...
*/
extern(C) void Z3_del_config (Z3_config c);
...
*/
extern(C) void Z3_set_param_value (Z3_config c, Z3_string param_id, Z3_string param_value);
...
*/
extern(C) Z3_context Z3_mk_context (Z3_config c);
...
*/
extern(C) Z3_context Z3_mk_context_rc (Z3_config c);
...
*/
extern(C) void Z3_del_context (Z3_context c);
...
*/
extern(C) void Z3_inc_ref (Z3_context c, Z3_ast a);
...
*/
extern(C) void Z3_dec_ref (Z3_context c, Z3_ast a);
...
*/
extern(C) void Z3_update_param_value (Z3_context c, Z3_string param_id, Z3_string param_value);
...
*/
extern(C) void Z3_interrupt (Z3_context c);
...
*/
extern(C) Z3_params Z3_mk_params (Z3_context c);
...
*/
extern(C) void Z3_params_inc_ref (Z3_context c, Z3_params p);
...
*/
extern(C) void Z3_params_dec_ref (Z3_context c, Z3_params p);
...
*/
extern(C) void Z3_params_set_bool (Z3_context c, Z3_params p, Z3_symbol k, bool v);
...
*/
extern(C) void Z3_params_set_uint (Z3_context c, Z3_params p, Z3_symbol k, uint v);
...
*/
extern(C) void Z3_params_set_double (Z3_context c, Z3_params p, Z3_symbol k, double v);
...
*/
extern(C) void Z3_params_set_symbol (Z3_context c, Z3_params p, Z3_symbol k, Z3_symbol v);
...
*/
extern(C) Z3_string Z3_params_to_string (Z3_context c, Z3_params p);
...
*/
extern(C) void Z3_params_validate (Z3_context c, Z3_params p, Z3_param_descrs d);
...
*/
extern(C) void Z3_param_descrs_inc_ref (Z3_context c, Z3_param_descrs p);
...
*/
extern(C) void Z3_param_descrs_dec_ref (Z3_context c, Z3_param_descrs p);
...
*/
extern(C) Z3_param_kind Z3_param_descrs_get_kind (Z3_context c, Z3_param_descrs p, Z3_symbol n);
...
*/
extern(C) uint Z3_param_descrs_size (Z3_context c, Z3_param_descrs p);
...
*/
extern(C) Z3_symbol Z3_param_descrs_get_name (Z3_context c, Z3_param_descrs p, uint i);
...
*/
extern(C) Z3_string Z3_param_descrs_get_documentation (Z3_context c, Z3_param_descrs p, Z3_symbol s);
...
*/
extern(C) Z3_string Z3_param_descrs_to_string (Z3_context c, Z3_param_descrs p);
...
*/
extern(C) Z3_symbol Z3_mk_int_symbol (Z3_context c, int i);
...
*/
extern(C) Z3_symbol Z3_mk_string_symbol (Z3_context c, Z3_string s);
...
*/
extern(C) Z3_sort Z3_mk_uninterpreted_sort (Z3_context c, Z3_symbol s);
...
*/
extern(C) Z3_sort Z3_mk_bool_sort (Z3_context c);
...
*/
extern(C) Z3_sort Z3_mk_int_sort (Z3_context c);
...
*/
extern(C) Z3_sort Z3_mk_real_sort (Z3_context c);
...
*/
extern(C) Z3_sort Z3_mk_bv_sort (Z3_context c, uint sz);
...
*/
extern(C) Z3_sort Z3_mk_finite_domain_sort (Z3_context c, Z3_symbol name, ulong size);
...
*/
extern(C) Z3_sort Z3_mk_array_sort (Z3_context c, Z3_sort domain, Z3_sort range);
...
*/
extern(C) Z3_sort Z3_mk_array_sort_n (Z3_context c, uint n, const(Z3_sort)* domain, Z3_sort range);
...
*/
extern(C) Z3_sort Z3_mk_tuple_sort (
			  Z3_context c,
...
*/
extern(C) Z3_sort Z3_mk_enumeration_sort (
				Z3_context c,
				Z3_symbol name,
				uint n,
...
*/
extern(C) Z3_sort Z3_mk_list_sort (
			 Z3_context c,
			 Z3_symbol name,
			 Z3_sort elem_sort,
...
*/
extern(C) Z3_constructor Z3_mk_constructor (
				  Z3_context c,
				  Z3_symbol name,
...
*/
extern(C) void Z3_del_constructor (Z3_context c, Z3_constructor constr);
...
*/
extern(C) Z3_sort Z3_mk_datatype (
			Z3_context c,
			Z3_symbol name,
...
*/
extern(C) Z3_constructor_list Z3_mk_constructor_list (
					    Z3_context c,
					    uint num_constructors,
...
*/
extern(C) void Z3_del_constructor_list (Z3_context c, Z3_constructor_list clist);
...
*/
extern(C) void Z3_query_constructor (
			   Z3_context c,
...
*/
extern(C) Z3_func_decl Z3_mk_func_decl (
			      Z3_context c,
			      Z3_symbol s,
			      uint domain_size,
...
*/
extern(C) Z3_ast Z3_mk_const (Z3_context c, Z3_symbol s, Z3_sort ty);
...
*/
extern(C) Z3_func_decl Z3_mk_fresh_func_decl (
				    Z3_context c,
				    Z3_string prefix,
				    uint domain_size,
				    const(Z3_sort)* domain,
...
*/
extern(C) Z3_ast Z3_mk_fresh_const (Z3_context c, Z3_string prefix, Z3_sort ty);
...
*/
extern(C) Z3_func_decl Z3_mk_rec_func_decl (
				  Z3_context c,
				  Z3_symbol s,
				  uint domain_size,
				  const(Z3_sort)* domain,
...
*/
extern(C) void Z3_add_rec_def (Z3_context c, Z3_func_decl f, uint n, Z3_ast* args, Z3_ast body);
...
*/
extern(C) Z3_ast Z3_mk_true (Z3_context c);
...
*/
extern(C) Z3_ast Z3_mk_false (Z3_context c);
...
*/
extern(C) Z3_ast Z3_mk_eq (Z3_context c, Z3_ast l, Z3_ast r);
...
*/
extern(C) Z3_ast Z3_mk_distinct (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_not (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_mk_ite (Z3_context c, Z3_ast t1, Z3_ast t2, Z3_ast t3);
...
*/
extern(C) Z3_ast Z3_mk_iff (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_implies (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_xor (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_and (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_or (Z3_context c, uint num_args, const(Z3_ast)* args);
/*@}*/
...
*/
extern(C) Z3_ast Z3_mk_add (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_mul (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_sub (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_unary_minus (Z3_context c, Z3_ast arg);
...
*/
extern(C) Z3_ast Z3_mk_div (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
*/
extern(C) Z3_ast Z3_mk_mod (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
*/
extern(C) Z3_ast Z3_mk_rem (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
*/
extern(C) Z3_ast Z3_mk_power (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
*/
extern(C) Z3_ast Z3_mk_lt (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_le (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_gt (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_ge (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_divides (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_int2real (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_real2int (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_is_int (Z3_context c, Z3_ast t1);
/*@}*/
...
*/
extern(C) Z3_ast Z3_mk_bvnot (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvredand (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvredor (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvand (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvor (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvxor (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvnand (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvnor (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvxnor (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvneg (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvadd (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsub (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvmul (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvudiv (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsdiv (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvurem (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsrem (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsmod (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvult (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvslt (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvule (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsle (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvuge (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsge (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvugt (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsgt (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_concat (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_extract (Z3_context c, uint high, uint low, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_sign_ext (Z3_context c, uint i, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_zero_ext (Z3_context c, uint i, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_repeat (Z3_context c, uint i, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvshl (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvlshr (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvashr (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_rotate_left (Z3_context c, uint i, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_rotate_right (Z3_context c, uint i, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_ext_rotate_left (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_ext_rotate_right (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_int2bv (Z3_context c, uint n, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bv2int (Z3_context c, Z3_ast t1, bool is_signed);
...
*/
extern(C) Z3_ast Z3_mk_bvadd_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2, bool is_signed);
...
*/
extern(C) Z3_ast Z3_mk_bvadd_no_underflow (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsub_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvsub_no_underflow (Z3_context c, Z3_ast t1, Z3_ast t2, bool is_signed);
...
*/
extern(C) Z3_ast Z3_mk_bvsdiv_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) Z3_ast Z3_mk_bvneg_no_overflow (Z3_context c, Z3_ast t1);
...
*/
extern(C) Z3_ast Z3_mk_bvmul_no_overflow (Z3_context c, Z3_ast t1, Z3_ast t2, bool is_signed);
...
*/
extern(C) Z3_ast Z3_mk_bvmul_no_underflow (Z3_context c, Z3_ast t1, Z3_ast t2);
/*@}*/
...
*/
extern(C) Z3_ast Z3_mk_select (Z3_context c, Z3_ast a, Z3_ast i);
...
*/
extern(C) Z3_ast Z3_mk_select_n (Z3_context c, Z3_ast a, uint n, const(Z3_ast)* idxs);
...
*/
extern(C) Z3_ast Z3_mk_store (Z3_context c, Z3_ast a, Z3_ast i, Z3_ast v);
...
*/
extern(C) Z3_ast Z3_mk_store_n (Z3_context c, Z3_ast a, uint n, const(Z3_ast)* idxs, Z3_ast v);
...
*/
extern(C) Z3_ast Z3_mk_const_array (Z3_context c, Z3_sort domain, Z3_ast v);
...
*/
extern(C) Z3_ast Z3_mk_map (Z3_context c, Z3_func_decl f, uint n, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_array_default (Z3_context c, Z3_ast array);
...
*/
extern(C) Z3_ast Z3_mk_as_array (Z3_context c, Z3_func_decl f);
...
*/
extern(C) Z3_ast Z3_mk_set_has_size (Z3_context c, Z3_ast set, Z3_ast k);
...
*/
extern(C) Z3_sort Z3_mk_set_sort (Z3_context c, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_empty_set (Z3_context c, Z3_sort domain);
...
*/
extern(C) Z3_ast Z3_mk_full_set (Z3_context c, Z3_sort domain);
...
*/
extern(C) Z3_ast Z3_mk_set_add (Z3_context c, Z3_ast set, Z3_ast elem);
...
*/
extern(C) Z3_ast Z3_mk_set_del (Z3_context c, Z3_ast set, Z3_ast elem);
...
*/
extern(C) Z3_ast Z3_mk_set_union (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_set_intersect (Z3_context c, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_set_difference (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
*/
extern(C) Z3_ast Z3_mk_set_complement (Z3_context c, Z3_ast arg);
...
*/
extern(C) Z3_ast Z3_mk_set_member (Z3_context c, Z3_ast elem, Z3_ast set);
...
*/
extern(C) Z3_ast Z3_mk_set_subset (Z3_context c, Z3_ast arg1, Z3_ast arg2);
...
extern(C) Z3_ast Z3_mk_array_ext (Z3_context c, Z3_ast arg1, Z3_ast arg2);
/*@}*/
...
*/
extern(C) Z3_ast Z3_mk_numeral (Z3_context c, Z3_string numeral, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_real (Z3_context c, int num, int den);
...
*/
extern(C) Z3_ast Z3_mk_int (Z3_context c, int v, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_unsigned_int (Z3_context c, uint v, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_int64 (Z3_context c, long v, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_unsigned_int64 (Z3_context c, ulong v, Z3_sort ty);
...
*/
extern(C) Z3_sort Z3_mk_seq_sort (Z3_context c, Z3_sort s);
...
*/
extern(C) bool Z3_is_seq_sort (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_sort Z3_get_seq_sort_basis (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_sort Z3_mk_re_sort (Z3_context c, Z3_sort seq);
...
*/
extern(C) bool Z3_is_re_sort (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_sort Z3_get_re_sort_basis (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_sort Z3_mk_string_sort (Z3_context c);
...
*/
extern(C) Z3_ast Z3_mk_lstring (Z3_context c, uint len, Z3_string s);
...
*/
extern(C) bool Z3_is_string (Z3_context c, Z3_ast s);
...
*/
extern(C) Z3_string Z3_get_string (Z3_context c, Z3_ast s);
...
*/
extern(C) Z3_string Z3_get_lstring (Z3_context c, Z3_ast s, uint* length);
...
*/
extern(C) Z3_ast Z3_mk_seq_empty (Z3_context c, Z3_sort seq);
...
*/
extern(C) Z3_ast Z3_mk_seq_unit (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_mk_seq_concat (Z3_context c, uint n, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_seq_prefix (Z3_context c, Z3_ast prefix, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_seq_suffix (Z3_context c, Z3_ast suffix, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_seq_contains (Z3_context c, Z3_ast container, Z3_ast containee);
...
*/
extern(C) Z3_ast Z3_mk_str_lt (Z3_context c, Z3_ast prefix, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_str_le (Z3_context c, Z3_ast prefix, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_seq_extract (Z3_context c, Z3_ast s, Z3_ast offset, Z3_ast length);
...
*/
extern(C) Z3_ast Z3_mk_seq_replace (Z3_context c, Z3_ast s, Z3_ast src, Z3_ast dst);
...
*/
extern(C) Z3_ast Z3_mk_seq_at (Z3_context c, Z3_ast s, Z3_ast index);
...
*/
extern(C) Z3_ast Z3_mk_seq_nth (Z3_context c, Z3_ast s, Z3_ast index);
...
*/
extern(C) Z3_ast Z3_mk_seq_length (Z3_context c, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_seq_index (Z3_context c, Z3_ast s, Z3_ast substr, Z3_ast offset);
...
*/
extern(C) Z3_ast Z3_mk_seq_last_index (Z3_context c, Z3_ast, Z3_ast substr);
...
*/
extern(C) Z3_ast Z3_mk_str_to_int (Z3_context c, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_int_to_str (Z3_context c, Z3_ast s);
...
*/
extern(C) Z3_ast Z3_mk_seq_to_re (Z3_context c, Z3_ast seq);
...
*/
extern(C) Z3_ast Z3_mk_seq_in_re (Z3_context c, Z3_ast seq, Z3_ast re);
...
*/
extern(C) Z3_ast Z3_mk_re_plus (Z3_context c, Z3_ast re);
...
*/
extern(C) Z3_ast Z3_mk_re_star (Z3_context c, Z3_ast re);
...
*/
extern(C) Z3_ast Z3_mk_re_option (Z3_context c, Z3_ast re);
...
*/
extern(C) Z3_ast Z3_mk_re_union (Z3_context c, uint n, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_re_concat (Z3_context c, uint n, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_re_range (Z3_context c, Z3_ast lo, Z3_ast hi);
...
*/
extern(C) Z3_ast Z3_mk_re_loop (Z3_context c, Z3_ast r, uint lo, uint hi);
...
*/
extern(C) Z3_ast Z3_mk_re_intersect (Z3_context c, uint n, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_mk_re_complement (Z3_context c, Z3_ast re);
...
*/
extern(C) Z3_ast Z3_mk_re_empty (Z3_context c, Z3_sort re);
...
*/
extern(C) Z3_ast Z3_mk_re_full (Z3_context c, Z3_sort re);
...
*/
extern(C) Z3_func_decl Z3_mk_linear_order (Z3_context c, Z3_sort a, uint id);
...
*/
extern(C) Z3_func_decl Z3_mk_partial_order (Z3_context c, Z3_sort a, uint id);
...
*/
extern(C) Z3_func_decl Z3_mk_piecewise_linear_order (Z3_context c, Z3_sort a, uint id);
...
*/
extern(C) Z3_func_decl Z3_mk_tree_order (Z3_context c, Z3_sort a, uint id);
...
*/
extern(C) Z3_func_decl Z3_mk_transitive_closure (Z3_context c, Z3_func_decl f);
...
*/
extern(C) Z3_pattern Z3_mk_pattern (Z3_context c, uint num_patterns, const(Z3_ast)* terms);
...
*/
extern(C) Z3_ast Z3_mk_bound (Z3_context c, uint index, Z3_sort ty);
...
*/
extern(C) Z3_ast Z3_mk_quantifier (
			 Z3_context c,
			 bool is_forall,
			 uint weight,
			 uint num_patterns,
...
*/
extern(C) Z3_ast Z3_mk_quantifier_ex (
			    Z3_context c,
			    bool is_forall,
			    uint weight,
...
*/
extern(C) Z3_ast Z3_mk_forall_const (
			   Z3_context c,
			   uint weight,
			   uint num_bound,
			   const(Z3_app)* bound,
...
*/
extern(C) Z3_ast Z3_mk_exists_const (
			   Z3_context c,
			   uint weight,
			   uint num_bound,
			   const(Z3_app)* bound,
...
*/
extern(C) Z3_ast Z3_mk_quantifier_const (
			       Z3_context c,
			       bool is_forall,
			       uint weight,
			       uint num_bound,
...
*/
extern(C) Z3_ast Z3_mk_quantifier_const_ex (
				  Z3_context c,
				  bool is_forall,
				  uint weight,
				  Z3_symbol quantifier_id,
...
*/
extern(C) Z3_ast Z3_mk_lambda_const (
			   Z3_context c,
			   uint num_bound,
			   const(Z3_app)* bound,
			   Z3_ast body);
...
*/
extern(C) Z3_symbol_kind Z3_get_symbol_kind (Z3_context c, Z3_symbol s);
...
*/
extern(C) int Z3_get_symbol_int (Z3_context c, Z3_symbol s);
...
*/
extern(C) Z3_string Z3_get_symbol_string (Z3_context c, Z3_symbol s);
...
*/
extern(C) Z3_symbol Z3_get_sort_name (Z3_context c, Z3_sort d);
...
*/
extern(C) uint Z3_get_sort_id (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_ast Z3_sort_to_ast (Z3_context c, Z3_sort s);
...
*/
extern(C) bool Z3_is_eq_sort (Z3_context c, Z3_sort s1, Z3_sort s2);
...
*/
extern(C) Z3_sort_kind Z3_get_sort_kind (Z3_context c, Z3_sort t);
...
*/
extern(C) uint Z3_get_bv_sort_size (Z3_context c, Z3_sort t);
...
*/
extern(C) Z3_bool Z3_get_finite_domain_sort_size (Z3_context c, Z3_sort s, ulong* r);
...
*/
extern(C) Z3_sort Z3_get_array_sort_domain (Z3_context c, Z3_sort t);
...
*/
extern(C) Z3_sort Z3_get_array_sort_range (Z3_context c, Z3_sort t);
...
*/
extern(C) Z3_func_decl Z3_get_tuple_sort_mk_decl (Z3_context c, Z3_sort t);
...
*/
extern(C) uint Z3_get_tuple_sort_num_fields (Z3_context c, Z3_sort t);
...
*/
extern(C) Z3_func_decl Z3_get_tuple_sort_field_decl (Z3_context c, Z3_sort t, uint i);
...
*/
extern(C) uint Z3_get_datatype_sort_num_constructors (Z3_context c, Z3_sort t);
...
*/
extern(C) Z3_func_decl Z3_get_datatype_sort_constructor (
					       Z3_context c,
					       Z3_sort t,
					       uint idx);
...
*/
extern(C) Z3_func_decl Z3_get_datatype_sort_recognizer (
					      Z3_context c,
					      Z3_sort t,
					      uint idx);
...
*/
extern(C) Z3_func_decl Z3_get_datatype_sort_constructor_accessor (
							Z3_context c,
							Z3_sort t,
							uint idx_c,
							uint idx_a);
...
*/
extern(C) Z3_ast Z3_datatype_update_field (
				 Z3_context c,
...
*/
extern(C) uint Z3_get_relation_arity (Z3_context c, Z3_sort s);
...
*/
extern(C) Z3_sort Z3_get_relation_column (Z3_context c, Z3_sort s, uint col);
...
*/
extern(C) Z3_ast Z3_mk_atmost (Z3_context c, uint num_args, const(Z3_ast)* args, uint k);
...
*/
extern(C) Z3_ast Z3_mk_atleast (Z3_context c, uint num_args, const(Z3_ast)* args, uint k);
...
*/
extern(C) Z3_ast Z3_func_decl_to_ast (Z3_context c, Z3_func_decl f);
...
*/
extern(C) bool Z3_is_eq_func_decl (Z3_context c, Z3_func_decl f1, Z3_func_decl f2);
...
*/
extern(C) uint Z3_get_func_decl_id (Z3_context c, Z3_func_decl f);
...
*/
extern(C) Z3_symbol Z3_get_decl_name (Z3_context c, Z3_func_decl d);
...
*/
extern(C) Z3_decl_kind Z3_get_decl_kind (Z3_context c, Z3_func_decl d);
...
*/
extern(C) uint Z3_get_domain_size (Z3_context c, Z3_func_decl d);
...
*/
extern(C) uint Z3_get_arity (Z3_context c, Z3_func_decl d);
...
*/
extern(C) Z3_sort Z3_get_domain (Z3_context c, Z3_func_decl d, uint i);
...
*/
extern(C) Z3_sort Z3_get_range (Z3_context c, Z3_func_decl d);
...
*/
extern(C) uint Z3_get_decl_num_parameters (Z3_context c, Z3_func_decl d);
...
*/
extern(C) Z3_parameter_kind Z3_get_decl_parameter_kind (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) int Z3_get_decl_int_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) double Z3_get_decl_double_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_symbol Z3_get_decl_symbol_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_sort Z3_get_decl_sort_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_ast Z3_get_decl_ast_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_func_decl Z3_get_decl_func_decl_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_string Z3_get_decl_rational_parameter (Z3_context c, Z3_func_decl d, uint idx);
...
*/
extern(C) Z3_ast Z3_app_to_ast (Z3_context c, Z3_app a);
...
*/
extern(C) Z3_func_decl Z3_get_app_decl (Z3_context c, Z3_app a);
...
*/
extern(C) uint Z3_get_app_num_args (Z3_context c, Z3_app a);
...
*/
extern(C) Z3_ast Z3_get_app_arg (Z3_context c, Z3_app a, uint i);
...
*/
extern(C) bool Z3_is_eq_ast (Z3_context c, Z3_ast t1, Z3_ast t2);
...
*/
extern(C) uint Z3_get_ast_id (Z3_context c, Z3_ast t);
...
*/
extern(C) uint Z3_get_ast_hash (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_sort Z3_get_sort (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_is_well_sorted (Z3_context c, Z3_ast t);
...
*/
extern(C) Z3_lbool Z3_get_bool_value (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast_kind Z3_get_ast_kind (Z3_context c, Z3_ast a);

/**
   def_API('Z3_is_app', BOOL, (_in(CONTEXT), _in(AST)))
*/
extern(C) bool Z3_is_app (Z3_context c, Z3_ast a);

/**
   def_API('Z3_is_numeral_ast', BOOL, (_in(CONTEXT), _in(AST)))
*/
extern(C) bool Z3_is_numeral_ast (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_is_algebraic_number (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_app Z3_to_app (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_func_decl Z3_to_func_decl (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_string Z3_get_numeral_string (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_string Z3_get_numeral_decimal_string (Z3_context c, Z3_ast a, uint precision);
...
*/
extern(C) double Z3_get_numeral_double (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_get_numerator (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_get_denominator (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_get_numeral_small (Z3_context c, Z3_ast a, long* num, long* den);
...
*/
extern(C) bool Z3_get_numeral_int (Z3_context c, Z3_ast v, int* i);
...
*/
extern(C) bool Z3_get_numeral_uint (Z3_context c, Z3_ast v, uint* u);
...
*/
extern(C) bool Z3_get_numeral_uint64 (Z3_context c, Z3_ast v, ulong* u);
...
*/
extern(C) bool Z3_get_numeral_int64 (Z3_context c, Z3_ast v, long* i);
...
*/
extern(C) bool Z3_get_numeral_rational_int64 (Z3_context c, Z3_ast v, long* num, long* den);
...
*/
extern(C) Z3_ast Z3_get_algebraic_number_lower (Z3_context c, Z3_ast a, uint precision);
...
*/
extern(C) Z3_ast Z3_get_algebraic_number_upper (Z3_context c, Z3_ast a, uint precision);
...
*/
extern(C) Z3_ast Z3_pattern_to_ast (Z3_context c, Z3_pattern p);
...
*/
extern(C) uint Z3_get_pattern_num_terms (Z3_context c, Z3_pattern p);
...
*/
extern(C) Z3_ast Z3_get_pattern (Z3_context c, Z3_pattern p, uint idx);
...
*/
extern(C) uint Z3_get_index_value (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_is_quantifier_forall (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_is_quantifier_exists (Z3_context c, Z3_ast a);
...
*/
extern(C) bool Z3_is_lambda (Z3_context c, Z3_ast a);
...
*/
extern(C) uint Z3_get_quantifier_weight (Z3_context c, Z3_ast a);
...
*/
extern(C) uint Z3_get_quantifier_num_patterns (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_pattern Z3_get_quantifier_pattern_ast (Z3_context c, Z3_ast a, uint i);
...
*/
extern(C) uint Z3_get_quantifier_num_no_patterns (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_get_quantifier_no_pattern_ast (Z3_context c, Z3_ast a, uint i);
...
*/
extern(C) uint Z3_get_quantifier_num_bound (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_symbol Z3_get_quantifier_bound_name (Z3_context c, Z3_ast a, uint i);
...
*/
extern(C) Z3_sort Z3_get_quantifier_bound_sort (Z3_context c, Z3_ast a, uint i);
...
*/
extern(C) Z3_ast Z3_get_quantifier_body (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_simplify (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_ast Z3_simplify_ex (Z3_context c, Z3_ast a, Z3_params p);
...
*/
extern(C) Z3_string Z3_simplify_get_help (Z3_context c);
...
*/
extern(C) Z3_param_descrs Z3_simplify_get_param_descrs (Z3_context c);
/*@}*/
...
*/
extern(C) Z3_ast Z3_update_term (Z3_context c, Z3_ast a, uint num_args, const(Z3_ast)* args);
...
*/
extern(C) Z3_ast Z3_substitute_vars (
			   Z3_context c,
			   Z3_ast a,
			   uint num_exprs,
			   const(Z3_ast)* to);
...
*/
extern(C) Z3_ast Z3_translate (Z3_context source, Z3_ast a, Z3_context target);
/*@}*/
...
*/
extern(C) Z3_model Z3_mk_model (Z3_context c);
...
*/
extern(C) void Z3_model_inc_ref (Z3_context c, Z3_model m);
...
*/
extern(C) void Z3_model_dec_ref (Z3_context c, Z3_model m);
...
*/
extern(C) Z3_bool Z3_model_eval (Z3_context c, Z3_model m, Z3_ast t, bool model_completion, Z3_ast* v);
...
*/
extern(C) Z3_ast Z3_model_get_const_interp (Z3_context c, Z3_model m, Z3_func_decl a);
...
*/
extern(C) bool Z3_model_has_interp (Z3_context c, Z3_model m, Z3_func_decl a);
...
*/
extern(C) Z3_func_interp Z3_model_get_func_interp (Z3_context c, Z3_model m, Z3_func_decl f);
...
*/
extern(C) uint Z3_model_get_num_consts (Z3_context c, Z3_model m);
...
*/
extern(C) Z3_func_decl Z3_model_get_const_decl (Z3_context c, Z3_model m, uint i);
...
*/
extern(C) uint Z3_model_get_num_funcs (Z3_context c, Z3_model m);
...
*/
extern(C) Z3_func_decl Z3_model_get_func_decl (Z3_context c, Z3_model m, uint i);
...
*/
extern(C) uint Z3_model_get_num_sorts (Z3_context c, Z3_model m);
...
*/
extern(C) Z3_sort Z3_model_get_sort (Z3_context c, Z3_model m, uint i);
...
*/
extern(C) Z3_ast_vector Z3_model_get_sort_universe (Z3_context c, Z3_model m, Z3_sort s);
...
*/
extern(C) Z3_model Z3_model_translate (Z3_context c, Z3_model m, Z3_context dst);
...
*/
extern(C) bool Z3_is_as_array (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_func_decl Z3_get_as_array_func_decl (Z3_context c, Z3_ast a);
...
*/
extern(C) Z3_func_interp Z3_add_func_interp (Z3_context c, Z3_model m, Z3_func_decl f, Z3_ast default_value);
...
*/
extern(C) void Z3_add_const_interp (Z3_context c, Z3_model m, Z3_func_decl f, Z3_ast a);
...
*/
extern(C) void Z3_func_interp_inc_ref (Z3_context c, Z3_func_interp f);
...
*/
extern(C) void Z3_func_interp_dec_ref (Z3_context c, Z3_func_interp f);
...
*/
extern(C) uint Z3_func_interp_get_num_entries (Z3_context c, Z3_func_interp f);
...
*/
extern(C) Z3_func_entry Z3_func_interp_get_entry (Z3_context c, Z3_func_interp f, uint i);
...
*/
extern(C) Z3_ast Z3_func_interp_get_else (Z3_context c, Z3_func_interp f);
...
*/
extern(C) void Z3_func_interp_set_else (Z3_context c, Z3_func_interp f, Z3_ast else_value);
...
*/
extern(C) uint Z3_func_interp_get_arity (Z3_context c, Z3_func_interp f);
...
*/
extern(C) void Z3_func_interp_add_entry (Z3_context c, Z3_func_interp fi, Z3_ast_vector args, Z3_ast value);
...
*/
extern(C) void Z3_func_entry_inc_ref (Z3_context c, Z3_func_entry e);
...
*/
extern(C) void Z3_func_entry_dec_ref (Z3_context c, Z3_func_entry e);
...
*/
extern(C) Z3_ast Z3_func_entry_get_value (Z3_context c, Z3_func_entry e);
...
*/
extern(C) uint Z3_func_entry_get_num_args (Z3_context c, Z3_func_entry e);
...
*/
extern(C) Z3_ast Z3_func_entry_get_arg (Z3_context c, Z3_func_entry e, uint i);
/*@}*/
...
*/
extern(C) bool Z3_open_log (Z3_string filename);
...
*/
extern(C) void Z3_append_log (Z3_string string);
...
*/
extern(C) void Z3_toggle_warning_messages (bool enabled);
/*@}*/
...
*/
extern(C) void Z3_set_ast_print_mode (Z3_context c, Z3_ast_print_mode mode);
...
*/
extern(C) Z3_string Z3_ast_to_string (Z3_context c, Z3_ast a);

/**
   def_API('Z3_pattern_to_string', STRING, (_in(CONTEXT), _in(PATTERN)))
*/
extern(C) Z3_string Z3_pattern_to_string (Z3_context c, Z3_pattern p);

/**
   def_API('Z3_sort_to_string', STRING, (_in(CONTEXT), _in(SORT)))
*/
extern(C) Z3_string Z3_sort_to_string (Z3_context c, Z3_sort s);

/**
   def_API('Z3_func_decl_to_string', STRING, (_in(CONTEXT), _in(FUNC_DECL)))
*/
extern(C) Z3_string Z3_func_decl_to_string (Z3_context c, Z3_func_decl d);
...
*/
extern(C) Z3_string Z3_model_to_string (Z3_context c, Z3_model m);
...
*/
extern(C) Z3_string Z3_benchmark_to_smtlib_string (
					 Z3_context c,
					 Z3_string name,
					 Z3_string logic,
					 Z3_string status,
...
*/
extern(C) Z3_ast_vector Z3_parse_smtlib2_string (
				       Z3_context c,
				       Z3_string str,
				       uint num_sorts,
				       const(Z3_symbol)* sort_names,
...
*/
extern(C) Z3_ast_vector Z3_parse_smtlib2_file (
				     Z3_context c,
				     Z3_string file_name,
				     uint num_sorts,
				     const(Z3_symbol)* sort_names,
...
extern(C) Z3_string Z3_eval_smtlib2_string (Z3_context, Z3_string str);
...
*/
extern(C) Z3_error_code Z3_get_error_code (Z3_context c);
...
*/
extern(C) void Z3_set_error_handler (Z3_context c, void function () h);
...
*/
extern(C) void Z3_set_error (Z3_context c, Z3_error_code e);
...
*/
extern(C) Z3_string Z3_get_error_msg (Z3_context c, Z3_error_code err);
...
*/
extern(C) void Z3_get_version (uint* major, uint* minor, uint* build_number, uint* revision_number);
...
*/
extern(C) Z3_string Z3_get_full_version ();
...
*/
extern(C) void Z3_enable_trace (Z3_string tag);
...
*/
extern(C) void Z3_disable_trace (Z3_string tag);
...
*/
extern(C) void Z3_finalize_memory ();
/*@}*/
...
*/
extern(C) Z3_goal Z3_mk_goal (Z3_context c, bool models, bool unsat_cores, bool proofs);
...
*/
extern(C) void Z3_goal_inc_ref (Z3_context c, Z3_goal g);
...
*/
extern(C) void Z3_goal_dec_ref (Z3_context c, Z3_goal g);
...
*/
extern(C) Z3_goal_prec Z3_goal_precision (Z3_context c, Z3_goal g);
...
*/
extern(C) void Z3_goal_assert (Z3_context c, Z3_goal g, Z3_ast a);
...
*/
extern(C) bool Z3_goal_inconsistent (Z3_context c, Z3_goal g);
...
*/
extern(C) uint Z3_goal_depth (Z3_context c, Z3_goal g);
...
*/
extern(C) void Z3_goal_reset (Z3_context c, Z3_goal g);
...
*/
extern(C) uint Z3_goal_size (Z3_context c, Z3_goal g);
...
*/
extern(C) Z3_ast Z3_goal_formula (Z3_context c, Z3_goal g, uint idx);
...
*/
extern(C) uint Z3_goal_num_exprs (Z3_context c, Z3_goal g);
...
*/
extern(C) bool Z3_goal_is_decided_sat (Z3_context c, Z3_goal g);
...
*/
extern(C) bool Z3_goal_is_decided_unsat (Z3_context c, Z3_goal g);
...
*/
extern(C) Z3_goal Z3_goal_translate (Z3_context source, Z3_goal g, Z3_context target);
...
*/
extern(C) Z3_model Z3_goal_convert_model (Z3_context c, Z3_goal g, Z3_model m);
...
*/
extern(C) Z3_string Z3_goal_to_string (Z3_context c, Z3_goal g);
...
*/
extern(C) Z3_string Z3_goal_to_dimacs_string (Z3_context c, Z3_goal g);
...
*/
extern(C) Z3_tactic Z3_mk_tactic (Z3_context c, Z3_string name);
...
*/
extern(C) void Z3_tactic_inc_ref (Z3_context c, Z3_tactic t);
...
*/
extern(C) void Z3_tactic_dec_ref (Z3_context c, Z3_tactic g);
...
*/
extern(C) Z3_probe Z3_mk_probe (Z3_context c, Z3_string name);
...
*/
extern(C) void Z3_probe_inc_ref (Z3_context c, Z3_probe p);
...
*/
extern(C) void Z3_probe_dec_ref (Z3_context c, Z3_probe p);
...
*/
extern(C) Z3_tactic Z3_tactic_and_then (Z3_context c, Z3_tactic t1, Z3_tactic t2);
...
*/
extern(C) Z3_tactic Z3_tactic_or_else (Z3_context c, Z3_tactic t1, Z3_tactic t2);
...
*/
extern(C) Z3_tactic Z3_tactic_par_or (Z3_context c, uint num, const(Z3_tactic)* ts);
...
*/
extern(C) Z3_tactic Z3_tactic_par_and_then (Z3_context c, Z3_tactic t1, Z3_tactic t2);
...
*/
extern(C) Z3_tactic Z3_tactic_try_for (Z3_context c, Z3_tactic t, uint ms);
...
*/
extern(C) Z3_tactic Z3_tactic_when (Z3_context c, Z3_probe p, Z3_tactic t);
...
*/
extern(C) Z3_tactic Z3_tactic_cond (Z3_context c, Z3_probe p, Z3_tactic t1, Z3_tactic t2);
...
*/
extern(C) Z3_tactic Z3_tactic_repeat (Z3_context c, Z3_tactic t, uint max);
...
*/
extern(C) Z3_tactic Z3_tactic_skip (Z3_context c);
...
*/
extern(C) Z3_tactic Z3_tactic_fail (Z3_context c);
...
*/
extern(C) Z3_tactic Z3_tactic_fail_if (Z3_context c, Z3_probe p);
...
*/
extern(C) Z3_tactic Z3_tactic_fail_if_not_decided (Z3_context c);
...
*/
extern(C) Z3_tactic Z3_tactic_using_params (Z3_context c, Z3_tactic t, Z3_params p);
...
*/
extern(C) Z3_probe Z3_probe_const (Z3_context x, double val);
...
*/
extern(C) Z3_probe Z3_probe_lt (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_gt (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_le (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_ge (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_eq (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_and (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_or (Z3_context x, Z3_probe p1, Z3_probe p2);
...
*/
extern(C) Z3_probe Z3_probe_not (Z3_context x, Z3_probe p);
...
*/
extern(C) uint Z3_get_num_tactics (Z3_context c);
...
*/
extern(C) Z3_string Z3_get_tactic_name (Z3_context c, uint i);
...
*/
extern(C) uint Z3_get_num_probes (Z3_context c);
...
*/
extern(C) Z3_string Z3_get_probe_name (Z3_context c, uint i);
...
*/
extern(C) Z3_string Z3_tactic_get_help (Z3_context c, Z3_tactic t);
...
*/
extern(C) Z3_param_descrs Z3_tactic_get_param_descrs (Z3_context c, Z3_tactic t);
...
*/
extern(C) Z3_string Z3_tactic_get_descr (Z3_context c, Z3_string name);
...
*/
extern(C) Z3_string Z3_probe_get_descr (Z3_context c, Z3_string name);
...
*/
extern(C) double Z3_probe_apply (Z3_context c, Z3_probe p, Z3_goal g);
...
*/
extern(C) Z3_apply_result Z3_tactic_apply (Z3_context c, Z3_tactic t, Z3_goal g);
...
*/
extern(C) Z3_apply_result Z3_tactic_apply_ex (Z3_context c, Z3_tactic t, Z3_goal g, Z3_params p);
...
*/
extern(C) void Z3_apply_result_inc_ref (Z3_context c, Z3_apply_result r);
...
*/
extern(C) void Z3_apply_result_dec_ref (Z3_context c, Z3_apply_result r);
...
*/
extern(C) Z3_string Z3_apply_result_to_string (Z3_context c, Z3_apply_result r);
...
*/
extern(C) uint Z3_apply_result_get_num_subgoals (Z3_context c, Z3_apply_result r);
...
*/
extern(C) Z3_goal Z3_apply_result_get_subgoal (Z3_context c, Z3_apply_result r, uint i);
...
*/
extern(C) Z3_solver Z3_mk_solver (Z3_context c);
...
*/
extern(C) Z3_solver Z3_mk_simple_solver (Z3_context c);
...
*/
extern(C) Z3_solver Z3_mk_solver_for_logic (Z3_context c, Z3_symbol logic);
...
*/
extern(C) Z3_solver Z3_mk_solver_from_tactic (Z3_context c, Z3_tactic t);
...
*/
extern(C) Z3_solver Z3_solver_translate (Z3_context source, Z3_solver s, Z3_context target);
...
*/
extern(C) void Z3_solver_import_model_converter (Z3_context ctx, Z3_solver src, Z3_solver dst);
...
*/
extern(C) Z3_string Z3_solver_get_help (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_param_descrs Z3_solver_get_param_descrs (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_set_params (Z3_context c, Z3_solver s, Z3_params p);
...
*/
extern(C) void Z3_solver_inc_ref (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_dec_ref (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_interrupt (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_push (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_pop (Z3_context c, Z3_solver s, uint n);
...
*/
extern(C) void Z3_solver_reset (Z3_context c, Z3_solver s);
...
*/
extern(C) uint Z3_solver_get_num_scopes (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_assert (Z3_context c, Z3_solver s, Z3_ast a);
...
*/
extern(C) void Z3_solver_assert_and_track (Z3_context c, Z3_solver s, Z3_ast a, Z3_ast p);
...
*/
extern(C) void Z3_solver_from_file (Z3_context c, Z3_solver s, Z3_string file_name);
...
*/
extern(C) void Z3_solver_from_string (Z3_context c, Z3_solver s, Z3_string file_name);
...
*/
extern(C) Z3_ast_vector Z3_solver_get_assertions (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_ast_vector Z3_solver_get_units (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_ast_vector Z3_solver_get_trail (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_ast_vector Z3_solver_get_non_units (Z3_context c, Z3_solver s);
...
*/
extern(C) void Z3_solver_get_levels (Z3_context c, Z3_solver s, Z3_ast_vector literals, uint sz, uint* levels);
...
*/
extern(C) Z3_lbool Z3_solver_check (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_lbool Z3_solver_check_assumptions (
				      Z3_context c,
				      Z3_solver s,
				      uint num_assumptions,
				      const(Z3_ast)* assumptions);
...
*/
extern(C) Z3_lbool Z3_get_implied_equalities (
				    Z3_context c,
				    Z3_solver s,
				    uint num_terms,
				    const(Z3_ast)* terms,
...
extern(C) Z3_lbool Z3_solver_get_consequences (
				     Z3_context c,
				     Z3_solver s,
...
extern(C) Z3_ast_vector Z3_solver_cube (Z3_context c, Z3_solver s, Z3_ast_vector vars, uint backtrack_level);
...
*/
extern(C) Z3_model Z3_solver_get_model (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_ast Z3_solver_get_proof (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_ast_vector Z3_solver_get_unsat_core (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_string Z3_solver_get_reason_unknown (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_stats Z3_solver_get_statistics (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_string Z3_solver_to_string (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_string Z3_solver_to_dimacs_string (Z3_context c, Z3_solver s);
...
*/
extern(C) Z3_string Z3_stats_to_string (Z3_context c, Z3_stats s);
...
*/
extern(C) void Z3_stats_inc_ref (Z3_context c, Z3_stats s);
...
*/
extern(C) void Z3_stats_dec_ref (Z3_context c, Z3_stats s);
...
*/
extern(C) uint Z3_stats_size (Z3_context c, Z3_stats s);
...
*/
extern(C) Z3_string Z3_stats_get_key (Z3_context c, Z3_stats s, uint idx);
...
*/
extern(C) bool Z3_stats_is_uint (Z3_context c, Z3_stats s, uint idx);
...
*/
extern(C) bool Z3_stats_is_double (Z3_context c, Z3_stats s, uint idx);
...
*/
extern(C) uint Z3_stats_get_uint_value (Z3_context c, Z3_stats s, uint idx);
...
*/
extern(C) double Z3_stats_get_double_value (Z3_context c, Z3_stats s, uint idx);
...
*/
extern(C) ulong Z3_get_estimated_alloc_size ();
